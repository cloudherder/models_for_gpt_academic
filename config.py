...
LLM_MODEL = "llamafile_internlm2" # 可选 ↓↓↓
AVAIL_LLM_MODELS = [
                    "ollama_gemma","ollama_internlm2",
                    "llamafile_gemma","llamafile_internlm2", "llamafile_qwen"
                    #,"llamafile_yi"
#                    "chatglm3", "claude-2", "zhipuai","gemini-pro"
                    ]
# P.S. 其他可用的模型还包括 [
# "gpt-4-1106-preview", "gpt-4-turbo-preview", "gpt-4-vision-preview",
#                     "gpt-3.5-turbo-1106", "gpt-3.5-turbo-16k", "gpt-3.5-turbo", "azure-gpt-3.5",
#                     "gpt-4", "gpt-4-32k", "azure-gpt-4", "api2d-gpt-4",# "moss", "qwen-turbo", "qwen-plus", "qwen-max"
...
LOCAL_MODEL_DEVICE = "cuda" # 可选 "cpu"
LOCAL_MODEL_QUANT = "BF16" # 默认 "FP16" "INT4" 启用量化INT4版本 "INT8" 启用量化INT8版本
